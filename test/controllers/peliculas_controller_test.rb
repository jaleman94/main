...
class PeliculasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pelicula" do
    assert_difference('Pelicula.count') do
      post peliculas_url, params: { pelicula: { description: @pelicula.description, main_actor: @pelicula.main_actor, name: @pelicula.name, stars: @pelicula.stars, year: @pelicula.year } }
    end
  ...
  test "should update pelicula" do
    patch pelicula_url(@pelicula), params: { pelicula: { description: @pelicula.description, main_actor: @pelicula.main_actor, name: @pelicula.name, stars: @pelicula.stars, year: @pelicula.year } }
